...
<script src="../../models/Reportes/app.potencia.gestionada.controlador.js"></script>
<div class="row">
    <div class="col-lg-12 col-sm-12">
        <div class="form-group">
            <h4 class="text-center">Potencia Gestionada - Controlador</h4>
        </div>
    </div>
    <div class="col-lg-12 col-sm-12">
        <div class="form-group">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            <div class="text-right">
                                <button type="submit" class="btn btn-dark btn-sm  form-control-sm" id="btnReportPG">Consultar</button>
                            </div>
                        </div>
                    </div>
                </div>
