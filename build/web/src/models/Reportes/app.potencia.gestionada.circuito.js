...
/*CREADOR TR*/
function tableTrCircuito(dia, fecha, nameCircuito,descripcion, H00, H01, H02, H03, H04, H05, H06, H07, H08, H09, H10, H11, H12, H13, H14, H15, H16, H17, H18, H19, H20, H21, H22, H23) {
    var response = "<tr>" +
            "<td>" + Null(dia) + "</td>" +
            "<td>" + Null(fecha) + "</td>" +
            "<td>" + Null(nameCircuito) + "</td>" +
            "<td>" + Null(descripcion) + "</td>" +
            "<td>" + Null(H00) + "</td>" +
            "<td>" + Null(H01) + "</td>" +
            "<td>" + Null(H02) + "</td>" +
            "<td>" + Null(H03) + "</td>" +
