...
function changeDias(val) {
    var nameDia = "";
    if (val === "1" || val == 1 || val ==="Su") {
        nameDia = "Domingo";
    }
    if (val === "2" || val == 2 || val ==="Mo") {
        nameDia = "Lunes";
    }
    if (val === "3" || val == 3 || val ==="Tu") {
        nameDia = "Martes";
    }
    if (val === "4" || val == 4 || val ==="We") {
        nameDia = "Miercoles";
    }
    if (val === "5" || val == 5 || val ==="Th") {
        nameDia = "Jueves";
    }
    if (val === "6" || val == 6 || val ==="Fr") {
        nameDia = "Viernes";
    }
    if (val === "7" || val == 7 || val ==="Sa") {
        nameDia = "Sabado";
    }
    return nameDia;
}
...
/*CREADOR TR*/
function tableTrCircuito(dia, fecha, H00, H01, H02, H03, H04, H05, H06, H07, H08, H09, H10, H11, H12, H13, H14, H15, H16, H17, H18, H19, H20, H21, H22, H23) {
    var response = "<tr>" +
            "<td>" + Null(dia) + "</td>" +
            "<td>" + Null(fecha) + "</td>" +
            "<td>" + Null(H00) + "</td>" +
