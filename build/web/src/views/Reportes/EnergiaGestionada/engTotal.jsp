...
<script src="../../models/Reportes/app.energia.gestionada.js"></script>
<div class="row">
    <div class="col-lg-12 col-sm-12">
        <div class="form-group">
            <h4 class="text-center">Energia Gestionada Total</h4>
        </div>
    </div>
    <div class="col-lg-12 col-sm-12">
        <div class="form-group">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            <div class="text-right">
                                <button type="submit" class="btn btn-dark btn-sm  form-control-sm" id="btnReportET">Consultar</button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            <div class="table-responsive">
                                 <div id="loadTableEnergyTotal"></div>
                            </div>
                        </div>
                    </div> 
                </div>
